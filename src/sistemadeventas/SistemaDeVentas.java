...
public class SistemaDeVentas {
    ...
    public static void main(String[] args) {
       ...
       // Usuario admin = new Usuario("Sebitas", "sebas", "123");
  ...
  /*
        ...
        //creando objetos ventas
        
        Venta v1 = new Venta(1,Configuracion.listaClientes.obtenerPersona("0000"),
                "express", true);
        
        Venta v2 = new Venta(2,Configuracion.listaClientes.obtenerPersona("0001"),
                "express", true); 
        
        v1.realizarOperacion(prod1, 3);
        v2.realizarOperacion(prod1, 5);
        
        //AGREGABNDO A LA COLA VENTAS
        
        Configuracion.colaventas.agregar(v1);
        Configuracion.colaventas.agregar(v2);
        
       
        
        System.out.println("->"+Configuracion.colaventas.obtenerVetna(1).getCliente().getNombre());
        
        System.out.println("->"+Configuracion.colaventas.obtenerVetna(2).getCliente().getNombre());
        
        
        
        Configuracion.colaventas.getMatrizVenta(1);
        
      
        
        
        /*
        System.out.println("Operaciones ralizadas");
        
        v1.realizarOperacion(Configuracion.listaProductos.obtenerProducto("1"),10);
        v2.realizarOperacion(Configuracion.listaProductos.obtenerProducto("1"),5);
        
        
        
        
        v1.getMatrizOperaciones();
         v2.getMatrizOperaciones();
         
         Configuracion.listaProductos.eliminarProducto("1");
         Configuracion.listaClientes.eliminarCliente("0000");
